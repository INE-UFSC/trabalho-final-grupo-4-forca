...
class Cenas:
    def __init__(self):
        ...
        self.cenas = [self.menuPrincipal, self.tutorial1, self.tutorial2, self.inicio, self.saguao, self.porao,
                      self.menuConfig, self.menuControles, self.menuEmJogo, self.menuInventario, self.menuSair0, self.cozinha]
        self.nomes = ["menuPrincipal", "tutorial1", "tutorial2", "inicio", "saguao", "porao",
                      "menuConfig", "menuControles", "menuEmJogo", "inventario", "menuSair0", "cozinha"]
